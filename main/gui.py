...
from monitoring_table import SimpleTable
...
class Application(Frame):
    ...
    def create_Comparer(self):
        ...
        self.comp_button = Button(self.tab_comparer, text="Compare", command=self.comparer_compare, font="Helvetica 15"
                                  , fg='black', bg=self.blue_btn_color, width=10).pack(side=TOP, anchor=CENTER, pady=(10, 10),
                                                                               padx=(240, 240))
        ...
        self.compare_Table1 = Text(tabs_Frame, height=20, width=60, borderwidth=2, relief="groove", bg=self.grey, fg=self.blue_btn_color)
        self.compare_Table1.pack(side=LEFT, padx=(20, 20), anchor=N)

        self.compare_Table2 = Text(tabs_Frame, height=20, width=60, borderwidth=2, relief="groove", bg=self.grey, fg=self.blue_btn_color)
    ...
    def send_Request(self):
        from Mon_Properties import url_global
    ...
    def create_Advanced(self):
        ...
        self.payload_Title = Label(self.payloads, text="Payloads", font="Helvetica 15", fg=self.blue_btn_color, bg=self.grey)
        self.payload_Title.grid(row=0, column=0,  padx=50, pady=(20, 5), sticky=NW, columnspan=2)

        self.listBox = Listbox(self.payloads, highlightthickness=3, highlightbackground=self.blue_btn_color, highlightcolor=self.blue_btn_color,
                               fg=self.blue_btn_color, bg=self.grey, font=self.myFont)
        self.listBox.configure(width=30, height=20)
        ...
        self.del_ph = self.del_img.subsample(20, 20)
        ...
        add_button.grid(row=1, column=0, sticky=NW, padx=390)
        ...
        delete_button.grid(row=1, column=0, sticky=NW, padx=390, pady=40)# pady=(100, 0)
        ...
        self.Cookie_Table = Label(self.cookies,  text="Cookies", font="Helvetica 15", fg=self.blue_btn_color, bg=self.grey)
        ...
        self.cookie_Check = Checkbutton(self.cookies, text="Use specific cookie", font=self.myFont,
                                        variable=self.cookie_var, command=self.enable_entry, fg=self.blue_btn_color, bg=self.grey)
        ...
        self.cookie_Entry = Entry(self.cookies, textvariable=entry_var, font=self.myFont_italic, fg=self.blue_btn_color, bg=self.grey,
        ...
        self.browsing_button = Button(self.cookies, font=self.myFont, state=NORMAL, text="Upload Cookie",
                                      command=self.browse_cookie, fg='black', bg=self.blue_btn_color).grid(row=4, column=0,
                                                                                                   sticky=NW, pady=10,
                                                                                                   padx=50)
        ...
        self.entr_cookie = Entry(self.cookies, font="Helvetica 15", width=40, textvariable=self.cookie_label_var,
                                 fg=self.blue_btn_color, bg=self.grey, state=DISABLED, disabledforeground=self.blue_btn_color,
        ...
        self.login_Title = Label(self.authentification, text="Http Authentication", font="Helvetica 15", fg=self.blue_btn_color, bg=self.grey)
        ...
        self.auth_check = Checkbutton(self.authentification, text="Use HTTP Authentication", font=self.myFont,
                                      variable=self.auth_var, command=self.auth_func, fg=self.blue_btn_color, bg=self.grey)

        self.auth_check.grid(row=1, column=0, pady=10, sticky=W, padx=50)
        self.user_Entry = Entry(self.authentification, font=self.myFont_italic, width=20, textvariable=self.entry_user_var,
        ...
        self.domain_entry = Entry(self.authentification, font=self.myFont_italic, width=20,
        ...
        self.domain_entry.insert(0, 'Enter Domain')
        self.domain_entry.bind("<Button-1>", self.clear_rep_entry)
        ...
        self.domain_entry.grid(row=4, column=0, pady=10, sticky=W, padx=50)

        self.php_check = Checkbutton(rfi_Frame, text="Use PHP Shell Exploit", font=self.myFont,
                                     variable=self.php_var, command=self.exploit_func, fg=self.blue_btn_color, bg=self.grey)
        ...
        self.entr_php = Entry(rfi_Frame, width=20, font="Helvetica 15", textvariable=self.php_label_var, fg=self.blue_btn_color,
                              bg=self.grey)
        ...
        self.timeout_Value = Text(self.http_settings, font=self.myFont, height=1, width=10, bg=self.grey, fg=self.blue_btn_color)
        ...
        self.header_add = Button(self.http_settings, text="Add Header", command=self.add_tree, image=self.add_ph, compound=LEFT, width=100)
        self.header_add.grid(row=4, column=0,  padx=(555,0), sticky=NW, pady=(10,0))

        self.header_del = Button(self.http_settings, text="Delete Header", command=self.delete_tree,  image=self.del_ph, compound=LEFT, width=100)
    ...
    def add_tree(self):
        ...
        value_label = Label(self.new_win, text="Value", font=self.myFont,
                            fg=self.blue_btn_color, background=self.grey)
        self.header_Entry_ = Entry(self.new_win, textvariable=self.header_var_, font=self.myFont, fg=self.blue_btn_color, bg=self.grey,
                                   disabledforeground=self.blue_btn_color, disabledbackground=self.grey, width=40)
        self.value_Entry_ = Entry(self.new_win, textvariable=self.value_var_, font=self.myFont, fg=self.blue_btn_color, bg=self.grey,
                                  disabledforeground=self.blue_btn_color, disabledbackground=self.grey, width=40)
    ...
    def create_main(self):
        ...
        self.create_Help()
        self.table = SimpleTable(self.tab3,  self.tab_parent, self.tools_notebook, self.tab_tools, self.tab5, self.request_Table, self.tab_comparer,
    ...
    def create_Decoder(self):
        ...
        self.decode_Table1 = Text(self.dec_Frame, height=10, width=120, borderwidth=2, relief="groove", bg=self.grey, fg=self.blue_btn_color)
        self.decode_Table1.pack(side=TOP, padx=(10, 10), anchor=W)

        self.decode_Table2 = Text(self.dec_Frame, height=10, width=120, borderwidth=2, relief="groove", bg=self.grey, fg=self.blue_btn_color)
        self.decode_Table2.pack(side=TOP, padx=(10, 10), pady=20, anchor=W)

        self.dec_Frame.pack(side=LEFT, anchor=NW, pady=10)
        self.encode_button = Button(self.tab_decoder, text="Encode as", fg='black', bg=self.blue_btn_color, command=self.on_field_encode, font=self.myFont).pack(padx=10, pady=(10, 0), anchor=W)
        ...
        self.decode_button = Button(self.tab_decoder, text="Decode as", fg='black', bg=self.blue_btn_color, command=self.on_field_decode, font=self.myFont).pack(padx=10,
                                                                                                      pady=(10, 0),
                                                                                                     anchor=W)
    ...
    def create_basicConf(self):
        ...
        self.proxyEntry_Adress = Text(self.tab2, bg=self.grey, fg=self.blue_btn_color, height=1, width=30, font="Helvetica 15 italic")
        ...
        threads_label = Label(self.tab2, text="Set the number of threads", font=self.myFont,
                              fg=self.blue_btn_color, background='#282c36')
        threads_label.grid(row=7, column=0, sticky=W, padx=30)
        self.treads_no = Scale(self.tab2, from_=1, to=20, orient=HORIZONTAL, length=200)
        ...
        self.button_Crawl = Checkbutton(self.tab2, fg=self.blue_btn_color, font=self.myFont,
                                        text="Use crawl links (Fuzzing all URL's connected to that site. It may take a while...)",
                                        background='#282c36',
        ...
        # self.button_Quite.configure()
        self.button_Quite.grid(row=9, column=1, sticky=W, pady=5, padx=10)

        self.use_https_button = Checkbutton(self.tab2, fg=self.blue_btn_color, font=self.myFont, text="Use HTTPS",
                                            background='#282c36', variable=self.https_box)
        self.use_https_button.grid(row=7, column=1, sticky=W, padx=10, pady=(40, 5))
        ...
        fuzzing_button.grid(row=11, column=0, columnspan=3, sticky=S, pady=70)
    ...
    def create_Monitoring(self):
        ...
        Label(self.dashBoard, borderwidth=2, font=font_Monitoring, fg=self.blue_btn_color, bg=self.grey, relief="groove",
    ...
    def create_Help(self):
        ...
        Button(self.tab_help, text="Back to Configuration!", image=self.photoimage, compound=LEFT, background=self.blue_btn_color,
    ...
    def addrow(self, status, content, length):
        ...
        Frame.update(self)
        self.table.add_row(status, content, length)
    ...
    def get_gui_proxy_server(self):
        if self.int_proxy.get() == 1:
            return self.proxyEntry_Adress.get('1.0', END)
        else:
            return None
    ...
    def get_gui_timeout(self):
        return self.timeout_Value.get('1.0', END)

    def get_gui_Port(self):
        return self.portValue.get('1.0', END)

    def get_gui_check_HTTPS(self):
        return self.https_box.get()
    ...
    def get_gui_cookie(self):
        ...
        else:  # we return the file of cookie s
            return self.cookie_label_var.get()
    ...
    def create_two_tabels(self, text_label1, text_label2, button_text, response_text, frame, font, funct):
        ...
        self.request_Text = Label(texts, text=text_label1, bg=self.grey, fg=self.blue_btn_color, font=font).pack(side=LEFT,
                                                                                                       padx=150,
                                                                                                       pady=20)
        ...
        self.request_ip = Entry(self.ip_stuff, bg=self.grey, fg=self.blue_btn_color, font="Helvetica 14", width=10)
        self.request_port = Entry(self.port_stuff, bg=self.grey, fg=self.blue_btn_color, font="Helvetica 14", width=10)
        ...
        Label(self.port_stuff, text="Target Port", bg=self.grey, fg=self.blue_btn_color, font=self.myFont).pack(side=LEFT,
                                                                                                      padx=(20, 0))
        ...
        self.request_Table = Text(tables_frame, height=30, width=60, borderwidth=2, relief="groove", bg=self.grey, fg=self.blue_btn_color)
        self.request_Table.pack(side=LEFT, padx=(300, 20))

        self.response_Table = Text(tables_frame, height=30, width=60, borderwidth=2, relief="groove", bg=self.grey, fg=self.blue_btn_color)
    ...
    def save_fuzzer_context(self):
        self.FuzzerObj = FuzzEngine(self.get_gui_IP(), self.get_gui_Port(), self.get_gui_cookie(),
                                    ...
                                    self.get_gui_php_shell(), self.get_gui_check_HTTPS(),
                                    self.get_gui_check_quite_mode()
                                    ,self.get_gui_proxy_server(), self.get_gui_threads_no(), "GET", "admin", "password",self.get_gui_Treeview_childs())
